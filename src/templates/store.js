...
export default class Store extends React.Component {
    render() {
        let product_pages = _.orderBy(getPages(this.props.pageContext.pages, '/products'), 'frontmatter.name');
            ...
            <main className="content store">
                ...
                <div className="content__row store__container">
                    ...
                    <section className="store__products">
                        <ProductGrid {...this.props} product_pages={product_pages} cssClass={'store__product-grid'} />
                    </section>
                </div>
